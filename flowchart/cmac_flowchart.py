...
with schemdraw.Drawing() as d:
    ...
    label13 = "Databases, Quick Looks, Etc.."
    label14 = "Interpolated Sonde or Sounding"
    d += flow.Process(w = 8).label(label13).color('black').fill('thistle').at([18, -24]).zorder(1)
    ...
    d += flow.Process(w = 27, h = 22).at((-1, -4)).zorder(0).fill('thistle')
